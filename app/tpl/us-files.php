							...
							<?php
								...
								if(!empty($fldArr['dirview'][$usrDir.$getBrowse]['files'])) {
									...
									foreach($fldArr['dirview'][$usrDir.$getBrowse]['files'] as $file) {
										...
										// Copy icon
										$copyIco = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-link" viewBox="0 0 16 16">
										...
										echo '<div class="col-md-2" style="text-align:center;"><span style="color:green; margin-right:22px;">' . $dlIco . '</span> <span style="color:blue; margin-right:22px;">' . $copyIco . '</span> <span style="color:red;">' . $delIco . '</span></div>';
									}
								}
