				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="row g-3">
							...
							<!-- Password -->
							<div class="col-md-3">
								<label for="inputPass" class="form-label">Password <svg class="float-end" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
