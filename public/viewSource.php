<?php
	...
	if(isset($_GET['vid']) && !empty($_GET['vid'])) {
		...
		echo '<iframe style="width:100%; max-height:650px;" src="https://nix.ac/viewSource.php?u=alex&p=RjZEYS9hS2RpRWYwRVk4dEswVjNLYkxBVGdTZytZRXZ6dTJ5VTlEdkFZelhGZVEwbmxETE5LcDE3S3BNUmlWQQ==" title=""></iframe>';
	}
?>