<?php
	...
	$client = new Client('b2d1d93495cc', [
		'keyId' => '003b2d1d93495cc0000000002', // optional if you want to use master key (account Id)
		'applicationKey' => 'K003L4gLu7XL9KcxlWroDBoNbcbAh7s',
	]);
